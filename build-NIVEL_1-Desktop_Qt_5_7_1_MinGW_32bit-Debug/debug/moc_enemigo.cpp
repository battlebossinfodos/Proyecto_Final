...
void enemigo::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        enemigo *_t = static_cast<enemigo *>(_o);
        Q_UNUSED(_t)
        switch (_id) {
...
const QMetaObject enemigo::staticMetaObject = {
    { &QObject::staticMetaObject, qt_meta_stringdata_enemigo.data,
      qt_meta_data_enemigo,  qt_static_metacall, Q_NULLPTR, Q_NULLPTR}
};
...
void *enemigo::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_enemigo.stringdata0))
        return static_cast<void*>(const_cast< enemigo*>(this));
    if (!strcmp(_clname, "QGraphicsPixmapItem"))
        return static_cast< QGraphicsPixmapItem*>(const_cast< enemigo*>(this));
